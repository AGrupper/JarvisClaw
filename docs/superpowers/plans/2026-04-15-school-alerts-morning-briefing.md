...
- [x] **Step 1: Add `🏫 School Alerts` to the layout block**
...
- [x] **Step 2: Add omit rule under Layout rules**
...
- [x] **Step 1: Add school alerts fetch to Step 1 (parallel fetches)**
...
- [x] **Step 2: Add school alerts to Step 3 (compose)**
...
- [x] **Step 3: Add Step 3.5 — mark alerts delivered**
...
- [x] **Step 1: Run the cron manually**
...
- [x] **Step 2: Force an urgent classification to test the dispatch path**
...
- [x] **Step 3: If `--mode now` fails — update cron prompt**
...
- [x] **Step 4: Commit if cron was changed**
